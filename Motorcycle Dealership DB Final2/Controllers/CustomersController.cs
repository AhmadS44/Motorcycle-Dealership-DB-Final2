...
namespace Motorcycle_Dealership_DB_Final2.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public CustomersController(Motorcycle_Dealership_DB_Final2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("CustomerID,FirstName,LastName,PhoneNumber,Address,Email")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CustomerID,FirstName,LastName,PhoneNumber,Address,Email")] Customer customer)
        {
